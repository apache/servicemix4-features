...
- using hotdeploy: 
   copy the wsdl-first-cxf-sa/target/wsdl-first-cxf-sa-3.3-SNAPSHOT.jar to <servicemix_home>/deploy
- using the ServiceMix console:
   osgi install -s mvn:org.apache.servicemix.samples.cxf-wsdl-first/wsdl-first-cxf-sa/3.3-SNAPSHOT/zip
